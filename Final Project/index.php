...
<div class="container-fluid p-5 my-5 bg-primary text-white">
  ...
  <p id="p1">Buy Any Medicine from Sitting at Your Home.</p>
  <p id="p1">So Just Create Your Account Now.</p>
...
<form name="med-form" id="med1" action="imagesubmit.php" method="post" >
...
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    <h4 class="card-title" name="title" value="Crocin">Crocin</h4>
    <p class="card-text" name="price" value="80Rs">80Rs</p>
    <button class="submit-btn" id="crocin" name="image1" value="crocin">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="accontin" name="image1" value="acc">Add to Cart</button>
  </div>
...
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="p" name="image1" value="p75">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="sumol" name="image1" value="sumol650">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="calpol" name="image1" value="calpol">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="otwo" name="image1" value="o2">Add to Cart</button>
  </div>
</div>
</div>
...
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="zinc" name="image1" value="zincovit">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="sine" name="image1" value="sinerest">Add to Cart</button>
  </div>
...
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="redt" name="image1" value="redtoil">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <button class="submit-btn" id="liv" name="image1" value="liv52">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">145Rs</p>
    <button class="submit-btn" id="sinemet" name="image1" value="sinemet">Add to Cart</button>
  </div>
</div>
<div class="card" style="width:200px; margin-left: 20px;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">80Rs</p>
    <button class="submit-btn" id="pir" name="image1" value="pirfenex">Add to Cart</button>
  </div>
</div>
</div>
</form>
